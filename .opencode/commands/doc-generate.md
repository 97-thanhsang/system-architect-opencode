---
description: "Automated documentation generation from code including API docs, architecture diagrams, and user guides"
argument-hint: "<project path> [--format openapi|markdown|html] [--output docs/]"
---
