...
@Component({
  selector: 'app-qc-testcases',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Test Cases</h1>
        <p class="page-subtitle">Quản lý các test case và kịch bản kiểm thử</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">fact_check</span>
        <p>Test Cases đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class QcTestcasesComponent {}
