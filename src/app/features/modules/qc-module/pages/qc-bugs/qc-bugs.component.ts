...
@Component({
  selector: 'app-qc-bugs',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Bug Reports</h1>
        <p class="page-subtitle">Theo dõi và quản lý bug reports</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">bug_report</span>
        <p>Bug Reports đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
