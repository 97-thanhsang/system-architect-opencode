  ...
  template: `
    <div class="g-page">
      <div class="page-header">
        ...
        <p class="page-subtitle">Báo cáo chất lượng và thống kê kiểm thử</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">bar_chart</span>
        <p>Reports đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class QcReportsComponent {}
