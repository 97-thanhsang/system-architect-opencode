...
@Component({
  selector: 'app-qc-testruns',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Test Runs</h1>
        <p class="page-subtitle">Thực thi và theo dõi các test run</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">play_circle</span>
        <p>Test Runs đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class QcTestrunsComponent {}
