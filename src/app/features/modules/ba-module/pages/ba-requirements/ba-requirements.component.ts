...
@Component({
  selector: 'app-ba-requirements',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Requirements</h1>
        <p class="page-subtitle">Quản lý các yêu cầu nghiệp vụ</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">list_alt</span>
        <p>Requirements đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class BaRequirementsComponent {}
