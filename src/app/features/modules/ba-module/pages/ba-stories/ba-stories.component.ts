...
@Component({
  selector: 'app-ba-stories',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">User Stories</h1>
        <p class="page-subtitle">Quản lý user stories và acceptance criteria</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">auto_stories</span>
        <p>User Stories đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class BaStoriesComponent {}
