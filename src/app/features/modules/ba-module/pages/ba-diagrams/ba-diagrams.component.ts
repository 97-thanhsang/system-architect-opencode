...
@Component({
  selector: 'app-ba-diagrams',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Diagrams</h1>
        <p class="page-subtitle">Sơ đồ luồng, use case và kiến trúc hệ thống</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">account_tree</span>
        <p>Diagrams đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class BaDiagramsComponent {}
