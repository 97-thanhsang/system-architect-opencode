...
@Component({
  selector: 'app-be-apis',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">APIs</h1>
        <p class="page-subtitle">Quản lý và kiểm tra các API endpoints</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">api</span>
        <p>APIs đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
