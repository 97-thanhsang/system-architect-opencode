...
@Component({
  selector: 'app-be-dashboard',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Backend Dashboard</h1>
        <p class="page-subtitle">Overview của hệ thống Backend</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">dashboard</span>
        <p>Dashboard đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class BeDashboardComponent {}
