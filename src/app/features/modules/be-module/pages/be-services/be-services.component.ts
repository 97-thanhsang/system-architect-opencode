...
@Component({
  selector: 'app-be-services',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Services</h1>
        <p class="page-subtitle">Quản lý các microservices và background jobs</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">miscellaneous_services</span>
        <p>Services đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class BeServicesComponent {}
