...
@Component({
  selector: 'app-be-database',
  standalone: true,
  template: `
    <div class="g-page">
      <div class="page-header">
        <h1 class="page-title">Database</h1>
        <p class="page-subtitle">Quản lý cơ sở dữ liệu và schema</p>
      </div>
      <div class="placeholder-content">
        <span class="material-icons-outlined placeholder-icon">storage</span>
        <p>Database đang được phát triển...</p>
      </div>
    </div>
  `,
  styles: [`
...
export class BeDatabaseComponent {}
