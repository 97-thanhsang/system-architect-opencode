...
$worktreeDir = 'E:/SOURCE/ems.finance.fe.worktree'
...
if ($orphaned.Count -eq 0) {
    ...
    try {
        ...
        Write-Host 'Some worktrees may still be in use (e.g., open in VS Code)' -ForegroundColor Yellow
        Write-Host 'Close all VS Code instances and try again' -ForegroundColor Gray
    }
}
